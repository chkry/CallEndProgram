...
/**
 * Created by chakradhar.reddy on 5/18/2017.
 */
/*
...
public interface ITelephony extends android.os.IInterface {
     ...
     */
    void dial(String number) throws android.os.RemoteException;
     ...
     */
    void call(String number) throws android.os.RemoteException;
     ...
     */
    boolean showCallScreen() throws android.os.RemoteException;
     ...
     * @see showCallScreen
     */
    boolean showCallScreenWithDialpad(boolean showDialpad) throws android.os.RemoteException;
     ...
     */
    boolean isOffhook() throws android.os.RemoteException;
     ...
     */
    boolean isRinging() throws android.os.RemoteException;
     ...
     */
    boolean isRadioOn() throws android.os.RemoteException;
     ...
     */
    boolean isSimPinEnabled() throws android.os.RemoteException;

    /**
     * Cancels the missed calls notification.
     */
    void cancelMissedCallsNotification() throws android.os.RemoteException;
     ...
     */
    boolean supplyPin(String pin) throws android.os.RemoteException;
     ...
     */
    boolean handlePinMmi(String dialString) throws android.os.RemoteException;
     ...
     */
    boolean setRadio(boolean turnOn) throws android.os.RemoteException;
     ...
     */
    int enableApnType(String type) throws android.os.RemoteException;

    /**
     * Disable a specific APN type.
     */
    int disableApnType(String type) throws android.os.RemoteException;
    ...
    android.os.Bundle getCellLocation() throws android.os.RemoteException;

    /**
     * Returns the neighboring cell information of the device.
     */
    java.util.List<android.telephony.NeighboringCellInfo> getNeighboringCellInfo() throws android.os.RemoteException;
     ...
     */
    int getCdmaEriIconIndex() throws android.os.RemoteException;
     ...
     * 1 - FLASHING
     */
    int getCdmaEriIconMode() throws android.os.RemoteException;

    /**
     * Returns the CDMA ERI text,
     */
    String getCdmaEriText() throws android.os.RemoteException;

    /**
     * Returns true if CDMA provisioning needs to run.
     */
    boolean getCdmaNeedsProvisioning() throws android.os.RemoteException;

    /**
     * Returns the unread count of voicemails
     */
    int getVoiceMessageCount() throws android.os.RemoteException;

    /**
     * Returns the network type
     */
    int getNetworkType() throws android.os.RemoteException;
     ...
     */
    abstract class Stub extends android.os.Binder implements ITelephony {
        ...
        private static final String DESCRIPTOR = "com.chkry.callendprogram.android.internal.telephony.ITelephony";
        ...
        /**
         * Cast an IBinder object into an com.chkry.callendprogram.android.internal.telephony.ITelephony interface,
